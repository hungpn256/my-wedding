        ...
        <LazyLoadComponent>
          <div className="container">
            <div className="row about-elems-wrapper">
                ...
                <div className="image">
                  ...
                  <div className="hover-info neela-style">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Là một lập trình viên hiện đang công tác tại Rikkeisoft
                        ở Hà Nội. Là một người thông minh và có tư duy sáng tạo.
                        Đặc biệt, anh có tài năng ca hát
                      </p>
              ...
              <div
                className="element col-md-6 col-xl-4 "
                data-aos="fade-up-left"
              >
                <div className="image flip">
                  <img
                    src={"compressor/2T9A6342.jpg"}
                    alt=""
                    width="600"
                    height="714"
                  />
                  <div className="hover-info neela-style">
                    ...
                    <div className="content">
                      ...
                      <p>
                        ...
                        tại Hà Nội. Với chiều cao 1m50, cô mang một nét đáng yêu
                        dễ thương khiến ai gặp cũng yêu mến.
                      </p>
                      <ul className="sn-icons">
                        <li>
                          <a href="https://instagram.com">
            ...
            <div className="row">
              ...
              >
                ...
                <p>
                  Thật vui vì được gặp và đón tiếp các bạn trong một dịp đặc
                  biệt như đám cưới của chúng tôi. Chúng tôi muốn gửi đến bạn
                  những lời cảm ơn sâu sắc nhất và để bạn biết chúng tôi rất
                  hạnh phúc khi thấy bạn ở đó. Cảm ơn các bạn rất nhiều vì sự
                  hiện diện cùng những lời chúc tốt đẹp mà bạn đã dành cho chúng
                  tôi!
                </p>
                      ...
                      <div className="description">
                        <div className="neela-style">
                          ...
                          <p>
                            ...
                            suy nghĩ của tôi khi ấy, gặp nhau chỉ để kết bạn
                            thôi, làm sao có thể nảy sinh tình cảm được? Ngày
                            đó, vì nghe lời con bạn thân thời đại học, tôi cũng
                            thử gặp gỡ, trò chuyện và rồi trở thành bạn bè.
                            Chúng tôi từng cùng nhau đăng ký tín chỉ, cùng học,
                            cùng làm bài tập lớn, chẳng hề nghĩ rằng cuộc đời sẽ
                            thay đổi. Và rồi 4 năm sau người ấy lại là bạn đời
                            của mình.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="description">
                        <div className="neela-style">
                          ...
                          <p>
                            ...
                            Khoảnh khắc ấy vẫn in sâu trong tâm trí tôi, bên
                            cạnh cây cô đơn ở Hồ Tây, bầu trời đêm lấp lánh
                            những đám mây sáng, tạo nên một khung cảnh tuyệt
                            đẹp. Anh nhẹ nhàng ôm tôi từ phía sau, nắm lấy bàn
                            tay tôi rồi khẽ thì thầm bên tai: "Mình chuyển từ
                            bạn thành người yêu nhé?"
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="description">
                        <div className="neela-style">
                          ...
                          <p>
                            ...
                            vượt qua những khó khăn trong cuộc sống. Chúng ta từ
                            2 con người xa lạ mà bước vào cuộc đời nhau. Và giờ
                            đây chúng ta tiếp tục cùng nhau sang trang mới. Giây
                            phút anh ngỏ lời “Làm vợ anh nhé!”, em đã nguyện ý
                      ...
                      <div className="description">
                        <div className="neela-style">
                          ...
                          <p>
                            ...
                            chờ đợi, cuối cùng ngày vui của chúng ta cũng tới
                            rồi. Cảm ơn vì mình đã luôn là một phần trong cuộc
                            sống của nhau. Em và anh không chỉ là người yêu mà
                            chúng ta còn là tri kỷ. Ngày hôm nay, em sẽ là cô
                            dâu của anh và sau này sẽ là mẹ của các con anh.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="row">
              <div className="col-md-8 col-xl-6 events-boxs py-5">
                ...
                <div
                  ...
                  data-aos="fade-up"
                >
                  Tình yêu đích thực đứng về phía nhau trong những ngày tốt đẹp
                  và sát cánh hơn trong những ngày tồi tệ.
                </div>
