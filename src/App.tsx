              ...
              <div className="row">
                ...
                >
                  ...
                  <p>
                    ...
                    hiện diện cùng những lời chúc tốt đẹp mà bạn đã dành cho
                    chúng tôi!
                  </p>
                      ...
                      <div className="description-wrapper">
                        <div className="description">
                          <div className="neela-style">
                            ...
                            <p>
                              “Tiếng trái tim đôi ta đập thật nhanh. Thì thầm
                              lời yêu thương. Ngày tình về chung đôi...” Sau bao
                              nhiêu chờ đợi, cuối cùng ngày vui của chúng ta
                              cũng tới rồi. Cảm ơn vì mình đã luôn là một phần
                              trong cuộc sống của nhau. Em và anh không chỉ là
                              người yêu mà chúng ta còn là tri kỷ. Ngày hôm nay,
                              em sẽ là cô dâu của anh và sau này sẽ là mẹ của
                              các con anh.
                            </p>
                          </div>
                        </div>
                  ...
                  >
                    ...
                    <div className="invite_info px-2 px-lg-4">
                      ...
                      <div>
                        ...
                        chúng tôi có thêm một niềm hạnh phúc!
                      </div>
                  ...
                  <div className="image">
                    ...
                    <div className="hover-info neela-style">
                      ...
                      <div className="content center">
                        ...
                        <p>
                          Là cô gái gái Huế thân thiện, hay cười, dễ giao tiếp
                          nhưng thích yên tĩnh một mình. Thường hướng về những
                          thói quen, sở thích mang tính truyền thống.
                          <a
                            className="button-see"
